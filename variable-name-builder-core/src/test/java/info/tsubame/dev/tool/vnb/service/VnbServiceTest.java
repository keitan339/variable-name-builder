...
public class VnbServiceTest {
    ...
    public void build_001() {
        ...
        String text = "定期預金通帳";
        String result = vnbService.build(text, FormatType.CLASS);
    ...
    public void build_011() {
        ...
        String text = "JNISA開設";
        String result = vnbService.build(text, FormatType.FIELD);
    ...
    public void build_012() {
        ...
        String text = "JNISA開設";
        String result = vnbService.build(text, FormatType.CONSTANT);
